...
# EDGE CONFIGURATION
func_PROPAGATIONTIME = "random.randint(3,5)"  # PD: 3–5 ms
func_BANDWITDH = "random.randint(6000000,60000000)"  # BW: 6*10^6 – 6*10^7 bit/s

# NODE CONFIG
func_NODERESOURECES = "random.randint(10,25)"  # RAM: 10–25 MB
func_NODESPEED = "random.randint(100,1000)"    # IPT: 100–1000 Instr/ms

# GATEWAY CONFIG
PERCENTATGEOFGATEWAYS = 0.25   # FG: 25%
PERCENTATGEOFGATEWAYS_CFG = 0.05  # CFG: 5% 
...
func_APPGENERATION = "nx.gn_graph(random.randint(2,20))" #algorithm for the generation of the random applications
...
#                j=random.randint(0,len(id_gateways)-1)
        ...
        print("Selesai Membuat User : %i "%len(myUsers))
...
if __name__ == '__main__':
    ...
    with open("data/networkDefinition.json","w") as f:
    ...
    with open("data/appDefinition.json","w") as f:
